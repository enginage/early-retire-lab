...
import PensionFundAccountDetail from './PensionFundAccountDetail';
...
function PensionFundAccountManagement() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-bold text-white mb-2">연금저축펀드 관리</h1>
        <p className="text-wealth-muted">연금저축펀드 계좌 정보를 관리하고 종목별 상세 정보를 확인하세요.</p>
      </div>
      ...
      <div className="bg-wealth-card/50 backdrop-blur-sm rounded-xl border border-gray-800 shadow-xl p-6">
        <div className="flex justify-between items-center mb-6">
          <div>
            <h2 className="text-xl font-semibold text-white">연금저축펀드 목록</h2>
          </div>
          <button
            onClick={handleAdd}
        ...
        {selectedAccountId && (
          <div className="mt-8">
            <PensionFundAccountDetail accountId={selectedAccountId} />
          </div>
        )}
      </div>
...
export default PensionFundAccountManagement;
